...
(** [business_logic::example10_retry::step_backoff]:
    Source: 'src/example10_retry.rs', lines 7:0-11:1 *)
...
(** [business_logic::example10_retry::compute_total_backoff]: loop 0:
    Source: 'src/example10_retry.rs', lines 22:4-27:5 *)
...
(** [business_logic::example10_retry::compute_total_backoff]:
    Source: 'src/example10_retry.rs', lines 13:0-30:1 *)
...
(** [business_logic::example10_retry::run_example]:
    Source: 'src/example10_retry.rs', lines 32:0-42:1 *)
...
(** [business_logic::example1_loyalty::compute_tier]:
...
(** [business_logic::example1_loyalty::update_customer_tier]:
    Source: 'src/example1_loyalty.rs', lines 39:0-42:1 *)
...
(** [business_logic::example1_loyalty::run_example]:
    Source: 'src/example1_loyalty.rs', lines 44:0-53:1 *)
...
(** [business_logic::example2_transfer::apply_transfer_effects]:
    Source: 'src/example2_transfer.rs', lines 6:0-9:1 *)
Definition example2_transfer_apply_transfer_effects
...
Definition example2_transfer_transfer
  ...
  then Ok (false, src, dst)
    ...
    then Ok (false, src, dst)
      ...
      p <- example2_transfer_apply_transfer_effects src dst amount_cents;
      let (src1, dst1) := p in
      Ok (true, src1, dst1))
.
...
(** [business_logic::example3_inventory::reconcile_reserved]:
...
(** [business_logic::example4_order::transition_from]:
...
(** [business_logic::example5_config::normalise_log_level]:
...
(** [business_logic::example6_grading::compute_weighted_mark]:
...
(** [business_logic::example7_moving_average::moving_average_at]:
...
(** [business_logic::example8_intervals::canonicalise_intervals]:
...
(** [business_logic::example9_pricing::shipping_cost_cents]:
